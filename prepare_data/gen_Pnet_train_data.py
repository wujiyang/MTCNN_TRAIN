        ...
        for box in boxes:
            ...
            for i in range(20):
                ...
                if IoU(crop_box, box_) >= 0.65:
                    save_file = os.path.join(pos_save_dir, "%s.jpg"%p_idx)  # positive samples with label 1 and offset
...
if __name__ == '__main__':
    ...
    # gen_pnet_data('training_data', 'anno_store/wider_origin_anno.txt',  '/home/wujiyang/data/Widerface/WIDER_train/images')
